...
cod_string = '\n'.join(cod)
#print(cod_string)
cod_regex = r"(\%presVAG)(\:)(\%germanic|\%romance|\%blended)(\:)(\%[0-9](half)?)(\:)(\%transitive|\%intransitive|\%prep_intransitive|\%ambiguous)(\@)([A-Z0-9\-]+)(\,)([A-Z0-9\.\,]+)"
...
##EXAMPLE:
#['%presVAG', ':', '%germanic', ':', '%1', '', ':', '%prep_intransitive', '@', 'CMAELR3-M23', ',', '26.8']
...
df.to_csv("prog_stats.csv", index=False, sep = ',')
