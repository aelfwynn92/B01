# SAMPLE 07-02-22: This script assigns ME forms to lemmas from spreadsheet from verblex_present.xlsx 'verblex_present_forspreadsheet'. It creates a list of lemmas by Word-length.
...
def sets_wordlength(lemma_list,wordlength):
    ...
    for index in range(len(lemma_list)):
        str_template = f'%{wordlength}: (*VBP*|*HVP*|*DOP*|*BEP* idoms '
...
columns = ['ME_lemma', 'word-length_ME', 'ME_lemma_1', 'ME_lemma_1half', 'ME_lemma_2', 'ME_lemma_2half', 'ME_lemma_3', 'ME_lemma_3half', 'ME_lemma_4', 'ME_lemma_else']
...
#print(df_3)
df_3half = df_wl[(df_wl['ME_lemma_3half'] == True)]
#print(df_3half)
df_4 = df_wl[(df_wl['ME_lemma_4'] == True)]
#print(df_4)
...
lemmas_3half = df_3half.ME_lemma.unique() #3half

print(f"lemmas_3half:")
print(lemmas_3half)

lemmas_4 = df_4.ME_lemma.unique() #4
...
# List of 2half-syllable lemmas
list_3half = sets_wordlength(lemmas_3half, '3half')
print(list_3half)
print('\n')

# List of 4-syllable lemmas
list_4 = sets_wordlength(lemmas_4, '4')
print(list_4)
print('\n')
...
with open("SAMPLE_nonprog_present_wordlength_layers.txt", 'w', encoding='utf-8') as f:
    f.write(list_1)
    f.write('\n')
    f.write(list_1half)
    f.write('\n')
